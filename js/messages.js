...
function updateTargetMode() {
  ...
  roleTargets.classList.toggle('visible', type === 'roles');
  if (hidden) selectedTarget.textContent = type === 'roles' ? 'Selecciona uno o ambos roles.' : type === 'docentes' ? 'Se enviará a todas las cuentas con rol maestro.' : type === 'direccion' ? 'Se enviará a dirección.' : 'Se enviará a todo el personal autorizado.';
